...
<html lang="es">
  ...
  <body>
		...
		<!-- ventana modal para elementos sin funcion -->
		...
		<!-- ventana modal para contraseña -->
		<div id="establecerContrasena" class="modal fade" role="dialog">
			<div class="modal-dialog">
				<!-- Modal content-->
				<div class="modal-content">
					<div class="form-group formulario">
						<div class="form-group">
							<label for="antigua-contr">Contraseña Actual</label>
							<input type="text" id="antigua-contr" class="form-control">
						</div>
						<div class="form-group">
							<label for="nueva-contr">Contraseña Nueva</label>
							<input type="text" id="nueva-contr" class="form-control">
						</div>
						<div class="form-group">
							<label for="confirmacion-contr">Repita la Contraseña</label>
							<input type="text" id="confirmacion-contr" class="form-control">
						</div>
						<div class="form-group">
							<button  class="btn btn-sm btn-primary" id="guardar-contr">Guardar</button>
						</div>
					</div>
				</div>
